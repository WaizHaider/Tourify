...
class AdventurousScreen extends StatefulWidget {
  ...
  @override
  _AdventurousScreenState createState() => _AdventurousScreenState();
}

class _AdventurousScreenState extends State<AdventurousScreen> {
  ...
  void loadData(String filter) {
    tours.clear();
    final ref = FirebaseDatabase.instance.ref().child('Tours').child('Adventure');
